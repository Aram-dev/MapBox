...
import static com.aram_dev.mapbox.pluginsapp.utils.IconUtilsKt.drawableToIcon;
...
import com.aram_dev.mapbox.pluginsapp.annotations.CityStateMarker;
import com.aram_dev.mapbox.pluginsapp.annotations.CityStateMarkerOptions;
...
public class InfoWindowAdapterActivity extends AppCompatActivity {
  ...
  private CityStateMarkerOptions generateCityStateMarker(String title, double lat, double lng, String color) {
    ...
    Icon icon = drawableToIcon(this, R.drawable.ic_location_city, Color.parseColor(color));
    marker.icon(icon);
    return marker;
  }
