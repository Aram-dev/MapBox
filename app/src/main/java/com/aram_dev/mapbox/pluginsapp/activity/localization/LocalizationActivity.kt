package com.aram_dev.mapbox.pluginsapp.activity.localization
...
import com.aram_dev.mapbox.pluginsapp.Utils
...
//      }
//      R.id.italian -> {
//        localizationPlugin?.setMapLanguage(MapLocale.ITALY)
//        return true
//      }
      R.id.local -> {
